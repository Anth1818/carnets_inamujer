export function CarnetFront() {
    return (
        <div id="frente" className="h-[750px] w-[500px] flex flex-col justify-start items-center mt-2  ">
            <h2 className="text-left font-bold ">Frente</h2>
            <div className="h-[620px] w-[400px] border-2">
                ...
                <div className="flex w-[400px] h-[200px] justify-around" >
                    ...
                    <div className="flex flex-col justify-around items-center h-[350px]  ">
