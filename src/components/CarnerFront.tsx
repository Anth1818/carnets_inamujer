...
export function CarnetFront({ refFront, worker_name, worker_cargo, worker_id, worker_gender}: ICarnetFrontProps) {
                ...
                <div className="flex h-[250px] justify-around bg-white" >
                    <div className="mx-2 -mt-16 h-auto">
                        ...
                        <div className="flex flex-col justify-center items-start">
                            <p className="text-2xl font-bold">{worker_name}</p>
                            <p className="text-lg font-bold">{worker_id}</p>
                        </div>
                    </div>

                    <div className="flex flex-col justify-around items-center h-[420px] z-10 ml-16">
                        <img src={imgUrl} alt="foto de trabajador" className="h-24 w-24 rounded-full" />
                        <img src="../../public/bandera_logo.png" alt="" className="h-24 w-36 " />
                    </div>
                </div>
                <p className="text-center w-[300px] absolute -mt-[60px] text-lg ml-[40px] font-bold leading-tight">Gerencia de Atención Integral y Prevención de la Violencia Contra la Mujer
                        </p>
                <footer >
