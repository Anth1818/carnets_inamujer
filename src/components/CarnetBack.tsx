...
export function CarnetBack({refBack}: ICarnetFrontProps) {
  return (
    <div  id="reverso" className="h-[720px] w-[550px] flex flex-col justify-start items-center mt-2 ">
      ...
      <div  ref={refBack} id="carnet-back"  className="min-h-[650px] min-w-[500px] border-2 box-border">
        ...
        <div className="w-[240px] h-[250px] -mt-20 text-[15px] ml-[80px] text-justify">
          ...
          <p className='w-[400px] z-10 mt-2 -ml-[60px] leading-tight'>Se les agradece a las autoridades civiles y militares prestar toda la colaboración para garantizar el normal desenvolvimiento de sus labores a la(el) portadora (or) de este carnet.</p>
          <div className='mt-3'>
        ...
        <div className=' text-[11px] absolute text-center leading-tight' >
          <p className='w-[290px] mt-24 ml-36'>En caso de extravió, favor remitir a: Av. Oeste3, Torre Bandagro, Piso 2, Altagracia, 1010, Caracas, Distrito Capital, Venezuela. Instituto Nacional de la Mujer, INAMUJER. <br /> Email: despachoinamujeroficial@Gmail.com <br /> Telf: (xxxx)-(XX XX XX)</p>
        </div>
        ...
        <footer>
          ...
          <div className="h-[35px] bg-custom-pattern3 bg-cover mt-3" >
